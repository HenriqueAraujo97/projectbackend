...
<body>
    ...
    <div class="main-div">
        ...
        <form action="assistCheck.php" method="post">
            <input type="number" placeholder="Enter assist id" name="assist_id" class="mt-3" required>
            <br>
            <input type="submit" value="Click here if assist checked" name="submit" class="btn btn-success mt-3">
        </form>
        <a href="employeeID.php" class="mt-3">Check Employees ID</a>
    </div>
